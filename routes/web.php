...
Route::get('/daftar-sertifikasi', 'App\Http\Controllers\visitorController@daftarSertifikasi');
Route::post('/daftar-sertifikasi', 'App\Http\Controllers\visitorController@daftarSertifikasiPost');

Route::group(['middleware' => 'type: 0'], function () {
    Route::get('/user-dashboard', 'App\Http\Controllers\asesiController@index');
    Route::get('/formulir', 'App\Http\Controllers\asesiController@uploadFormulir');
});
