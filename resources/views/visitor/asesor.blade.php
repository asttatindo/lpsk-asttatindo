    ...
    <section class="section">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <tr>
                                ...
                                <th class="tengah">Nama Asesor</th>
                                <th class="tengah">NIK</th>
                                <th class="tengah">Asesor Tercatat di LPJK</th>
                                <th class="tengah">Sertifikat Asesor dari BNSP</th>
                                <th class="tengah">Sub-klasifikasi</th>
                                <th class="tengah">Kualifikasi</th>
        ...
        ?>
                            <tr>
                                ...
                                <td>{{ $acc->nama }}</td>
                                <td>{{ $acc->nik }}</td>
                                <td class="tengah"><?php switch ($acc->lpjk) {
                                    case true:
