                        ...
                        <ul class="paddingaa">
                            <b>
                                <li class="margind">
                                    ...
                                    <ul>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="#visi">VISI & MISI </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/struktur">STRUKTUR </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/legalitas">LEGALITAS </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="margind">
                                    ...
                                    <ul>
                                        ...
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/proses-permohonan">PROSES PERMOHONAN </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/data-asesor">ASESOR </a>
                                        </li>
                                        <li class="marginb">
                                        ...
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/skema">SKEMA </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/tuk">TUK </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/unduh-persyaratan">UNDUH PERSYARATAN </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="margind">
                                    ...
                                    <ul>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/cek-keanggotaan">CEK KEANGGOTAAN </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/statistik-ahli">STATISTIK AHLI </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="/statistik-teknisi">STATISTIK TEKNISI </a>
                                        </li>
                                        <li class="marginb">
                                ...
                                <li class="margind">
                                    ...
                                    <ul>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="#galeri">KEGIATAN SERTIFIKASI </a>
                                        </li>
                                        <li class="marginb">
                                            <a class="paddinga margina" href="#galeri">KEGIATAN TAHUNAN </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="margind">
                                    <a href="#alamat">HUBUNGI </a>
                                </li>
                            </b>
                        </ul>
                    </div>
    ...
    <section id="feed" class="home">
        ...
        <div class="slider-text-wrapper">
            ...
            <div class="container">
                ...
                <?php endforeach; ?>
                <a href="/daftar-sertifikasi" class="middle btn btn-white">DAFTAR SERTIFIKASI
                </a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="blog-post">
                            ...
                            <div class="post-desc">
                                <h4>
                                    <?php if (strlen($postingan->judul) > 30) {
                                        echo substr($postingan->judul, 0, 26) . '...';
                                    } else {
                                        echo "$postingan->judul";
                                    } ?>
                                </h4>
                                <p>
                                    <?php if (strlen($postingan->subjudul) > 30) {
                                        echo substr($postingan->subjudul, 0, 33) . '...';
                                    } else {
                                        echo "$postingan->subjudul";
                                    } ?>
                                </p>
...
<footer class="footer">
    <div class="footer__addr" id="alamat">
        ...
        <p class="nav__title">Asosiasi Tenaga Teknik Ahli dan Terampil Indonesia (ASTTATINDO) adalah asosiasi
            profesi bidang jasa konstruksi yang merupakan wadah organisasi tenaga teknik ahli dan tenaga terampil.
        </p>
    </div>
